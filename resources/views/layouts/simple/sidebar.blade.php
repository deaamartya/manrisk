		...
		<nav class="sidebar-main">
			...
			<div id="sidebar-menu">
				<ul class="sidebar-links" id="simple-bar">
					...
					<li class="sidebar-list">
						<a class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='risk-officer.pengukuran-korporasi' ? 'active' : '' }}" href="{{route('risk-officer.pengukuran-risiko-indhan')}}">
							<i data-feather="edit"></i>
							<span>Pengukuran Risiko Indhan</span>
						</a>
					</li>
					<li class="sidebar-list">
						<a class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='risk-officer.risiko' ? 'active' : '' }}" href="{{route('risk-officer.risiko')}}">
							<i data-feather="list"></i>
