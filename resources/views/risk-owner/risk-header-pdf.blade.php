...
<body>
    ...
    <table class="table-header" cellspacing="0" width="100%">
    	<tr>
    		...
    		<td width="143">
    			<img src="{{ $_SERVER['DOCUMENT_ROOT'].'/assets/images/logo/logo_company/logo_'.$header->perusahaan->company_code.'.png' }}" style="width:120px;" />
    		</td>
    	</tr>
    </table>
    <table class="table-2" cellspacing="0" width="100%">
    	...
    	<tr>
    		<td class="f-13 center" colspan="8">
    			IDENTIFIKASI
    		</td>
