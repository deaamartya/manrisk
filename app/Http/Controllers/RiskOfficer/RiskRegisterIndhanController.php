...
class RiskRegisterIndhanController extends Controller
{
    public function index()
    {
        ...
        // dd($jml_risk);
        return view('risk-officer.risk-register-indhan', compact('headers', 'jml_risk'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('risk-officer.risk-register-indhan.index')->with(['success-swal' => 'Risk Header INDHAN berhasil disimpan!']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('risk-officer.risk-register-indhan.index')->with(['success-swal' => 'Risk Header INDHAN berhasil diubah!']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('risk-officer.risk-register-indhan.index')->with(['success-swal' => 'Risk Header INDHAN berhasil dihapus!']);
    }
    ...
    public function uploadLampiran(Request $request) {
        ...
        ->join('pengajuan_mitigasi', 'risk_detail.id_riskd', 'pengajuan_mitigasi.id_riskd' )
                ...
                ->count();
            // dd($detail_risk);
        return redirect()->route('risk-officer.risk-register-indhan.show', $id)->with(['success-swal' => 'Lampiran berhasil diupload!', 'headers' => $headers,  'detail_risk' => $detail_risk, 'mitigasi' => $mitigasi]);
    }
    ...
    public function print($id) {
        ...
        $detail_risk = RiskHeader::join('risk_detail', 'risk_header.id_riskh', 'risk_detail.id_riskh' )
            ...
            // dd($detail_risk);
        // $user = Auth::user();
        $pdf = PDF::loadView('risk-officer.pdf-risk-register-indhan', compact('header', 'detail_risk'))->setPaper('a4', 'landscape');
